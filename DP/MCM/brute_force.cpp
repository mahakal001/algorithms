...
long long mcm_brute_force(std::vector<long long>& mats_dims,std::vector<std::vector<int>>& dyn_table,long long n,long long start_i,long long end_j){
    ...
    for(long long k = start_i ; k <  end_j ; k++ ){ 
        long long total_product_ops =  mcm_brute_force(mats_dims,dyn_table,n,start_i,k) + 
                                       mcm_brute_force(mats_dims,dyn_table,n,k+1,end_j) +
    ...
    dyn_table[start_i][end_j] = minimum_val ;
}
...
long long mcm(std::vector<long long>& mats_dims ){
    ...
    dyn_table[1][n] = mcm_brute_force(mats_dims,dyn_table,n,1,n);
